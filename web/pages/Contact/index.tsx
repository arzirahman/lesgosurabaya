            ...
            <div className='p-[70px] flex flex-col gap-[60px] w-full max-w-[1440px] mx-auto mb-[30px] z-[-1]'>
                ...
                <div className='flex gap-[120px] justify-center'>
                    ...
                    <div className='flex flex-col items-center gap-2 py-[25px] px-2 rounded-[20px] bg-[#D9D9D9] w-[370px]'>
                        ...
                        <span className='text-xl'>Wonorejo Selatan no.17, Surabaya</span>
                    </div>
                </div>
            </div>
            <Footer iconClassname='w-[555px] absolute bottom-0 right-[-50px] z-[-1]' />
        </div>
    )
}