...
export default function Section5() {
    return (
        <div className='w-full items-center justify-center pt-[20px] pb-[30px] flex flex-col px-[80px]'>
            <div className='flex gap-10 justify-between items-center relative w-full max-w-[1440px]'>
            ...
            <div className='flex flex-col font-semibold text-[15px] w-full max-w-[1440px] mb-[20px]'>
