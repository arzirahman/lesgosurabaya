export default function Section3() {
    return (
        <div className="w-full px-[70px] pb-[55px]">
            <div className="w-full flex gap-[75px] max-w-[1440px] mx-auto items-center">
                <div className="flex-1 font-bold text-[64px] leadinf-[76px]">
